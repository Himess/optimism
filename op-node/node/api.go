...
func (a *opstackAPI) CommitBlockV1(ctx context.Context, envelope *eth.SignedExecutionPayloadEnvelope) error {
	recordDur := a.m.RecordRPCServerRequest("opstack_commitBlockV1")
	defer recordDur()
	return a.engine.CommitBlock(ctx, envelope)
}

func (a *opstackAPI) PublishBlockV1(ctx context.Context, signed *eth.SignedExecutionPayloadEnvelope) error {
